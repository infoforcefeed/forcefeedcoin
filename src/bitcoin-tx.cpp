...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s forcefeedcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  forcefeedcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded forcefeedcoin transaction") + "\n" +
              "  forcefeedcoin-tx [options] -create [commands]   " + _("Create hex-encoded forcefeedcoin transaction") + "\n" +
              "\n";
