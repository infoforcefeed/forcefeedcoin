...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.forcefeedcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("forcefeedcointools.com", "dnsseed.forcefeedcointools.com"));
        vSeeds.push_back(CDNSSeedData("forcefeedcoinpool.org", "dnsseed.forcefeedcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("forcefeedcointools.com", "testnet-seed.forcefeedcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.forcefeedcoin.loshan.co.uk", true));
