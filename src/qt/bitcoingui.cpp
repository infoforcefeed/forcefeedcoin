...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and forcefeedcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a forcefeedcoin: URI or payment request"));
