...
const char * const BITCOIN_CONF_FILENAME = "forcefeedcoin.conf";
const char * const BITCOIN_PID_FILENAME = "forcefeedcoin.pid";
...
#else
    const char* pszModule = "forcefeedcoin";
#endif
    if (pex)
        return strprintf(
